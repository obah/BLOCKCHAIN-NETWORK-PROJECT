...
class Wallet:
    ...
    Keep's track of the miner's balance.
    ...
    def calculate_balance(blockchain, address):
        """
        Calculates the balance of the given address, considering 
        the transaction data within the blockchain.

        The balance is found by adding the output that belong to the address 
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    #Anytime the address conducts a new transaction,
